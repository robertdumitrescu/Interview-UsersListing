...
<!--
                    ...
                    <div class="col-md-6" style="text-align: center;">
                        ...
                        <div style="font-size: 30px; font-style: italic; font-weight: bold; color: #404040; line-height: 50px;">
                            <div style="margin-top: 40px;">
                                Advanced Data Grid<br/>for Javascript
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>
                        People use Angular Grid over other free and paid grids because it's
                        <b>faster, more stable and better written</b>.
                    </p>
                </div>

                <div class="col-md-6">
                    <!--<h2>Hybrid AngularJS & DOM Engine</h2>-->
                    <p>
                        Angular Grid is <b>hybrid</b>, working with AngularJS,
                        but not depending on AngularJS internally. A grid written solely in
                        AngularJS will be inherently slower.
                        <a href="/why-the-world-needed-another-angularjs-grid/">learn more...</a>
                    </p>
                    <p>
                        <b>AngularJS is optional</b> - Angular Grid works without AngularJS.
                        <a href="/example-html5-datagrid/index.php">learn more...</a>
...
<script src="./dist/angular-grid.min.js?ignore=notused5"></script>
<link rel="stylesheet" type="text/css" href="./dist/angular-grid.min.css?ignore=notused5">
<link rel="stylesheet" type="text/css" href="./dist/theme-fresh.min.css?ignore=notused5">
<link rel="stylesheet" type="text/css" href="./dist/theme-dark.min.css?ignore=notused5">

<link href="example-file-browser/fileBrowser.css?ignore=notused5" rel="stylesheet">
<link href="example-data-grid/basic.css?ignore=notused5" rel="stylesheet">
<link href="example-account-report/account.css?ignore=notused5" rel="stylesheet">

<script src="example-data-grid/basic.js?ignore=notused5"></script>
<script src="example-account-report/account.js?ignore=notused5"></script>
<script src="example-file-browser/fileBrowser.js?ignore=notused5"></script>
